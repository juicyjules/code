...
VM_OPTIONS_FILE=""
if [ -n "$STUDIO_VM_OPTIONS" -a -r "$STUDIO_VM_OPTIONS" ]; then
  # explicit
  VM_OPTIONS_FILE="$STUDIO_VM_OPTIONS"
elif [ -r "$IDE_HOME.vmoptions" ]; then
  # Toolbox
  VM_OPTIONS_FILE="$IDE_HOME.vmoptions"
elif [ -r "$HOME/.AndroidStudio3.1/config/studio$BITS.vmoptions" ]; then
  # user-overridden
  VM_OPTIONS_FILE="$HOME/.AndroidStudio3.1/config/studio$BITS.vmoptions"
elif [ -r "$IDE_BIN_HOME/studio$BITS.vmoptions" ]; then
  ...
  VM_OPTIONS_FILE="$IDE_BIN_HOME/$OS_SPECIFIC/studio$BITS.vmoptions"
fi
